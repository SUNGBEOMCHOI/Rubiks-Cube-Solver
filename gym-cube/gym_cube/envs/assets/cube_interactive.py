...
class Cube:
    ...
    x, y, z = np.eye(3) # x = [1 ,0, 0], y = [0, 1, 0], z = [0, 0, 1]
    ...
    def _initialize_arrays(self):
        ...
        for i in range(6):
            ...
            # as_rotation_matrix() : normalized rotation matrix를 rotation matrix로 변환
...
class InteractiveCube(plt.Axes):
    ...
    def _initialize_widgets(self):
        ...
        # randomize cube 
        ###############################
        self._ax_random = self.figure.add_axes([0.75, 0.05, 0.2, 0.075])
        self._btn_random = widgets.Button(self._ax_random, "Randomize")
